...
<body style="background-color: rgba(226, 223, 223, 0.842);">
  <div class="sidebar">
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          <li><a class="link_name" href="HazardAdmin.php">Hazard</a></li>
  ...
  <div class="admin-content" style="background-color: rgba(226, 223, 223, 0.842);">
    ...
    <div class="card shadow mb-4">
          ...
          if(isset($_POST['edit_topics_btn']))
          {
              $id=$_POST['edit_id'];
            ...
            <form action="UpdateValid.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group" style="width:96%; margin-left:2%">
                    <label>Title</label>
                    <input type="text" name="Edit_TitleTopics" value="<?php echo $row['title'] ?>" class="form-control">
                </div>
                <div class="form-group" style="width:96%; margin-left:2%">
                    <label>Title</label>
                    <input type="text" name="Edit_subTitleTopics" value="<?php echo $row['sub_title'] ?>" class="form-control">
                </div>
                <div class="caasda" style="display:flex; margin:2% " >
                    <a href="TopicsAdmin.php" class="btn btn-danger" style="height:40px; margin-right:.5%;" >Cancel </a>
                    <button type="submit" class="btn btn-primary" name="Topics_updatebtn"> Update </button>
                </div>
            </form>
