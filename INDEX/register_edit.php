...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Update News Update</title>
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="RightSide.php">Right Side</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
        ...
        if(isset($_POST['edit_btn']))
        {
            ...
            <form action="UpdateValid.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group" style="width:96%; margin-left:2%">
                    <label>Title</label>
                  <input type="text" name="NewsName" id="HotlineName" class="form-control" value="<?php echo $row['title'] ?>">
                </div>
                <div class="form-group" style="width:96%; margin-left:2%">
                    <label>Date</label>
                    <input type="date" name="EditDate" value="<?php echo $row['date'] ?>"class="form-control">
                </div>
                <div class="caasda" style="display:flex; margin:2% " >
                    <a href="NewUpdateAdmin.php" class="btn btn-danger" style="height:40px; margin-right:.5%;" >Cancel </a>
